          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form  method="post" enctype="multipart/form-data" action="<?=base_url('blog/add-blog');?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputTitle1">Title</label>
                      <input type="text" class="form-control" id="exampleInputTitle1" placeholder="Enter Title" name="title" value="<?=set_value('title')?>">
                      <span class="help-block error"><?=form_error('title'); ?></span>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputTitle1">Slect File</label>
                      <input type="file" class="form-control" id="exampleInputTitle1" placeholder="file" name="file" value="<?=set_value('file')?>">
                      <span class="help-block error"><?=form_error('file'); ?></span>
                    </div>

                    <div class="form-group">
                    <label for="exampleInputFile">Description</label>
                    <textarea id="editor1" name="offer" rows="10" cols="80"></textarea>
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputTitle1" placeholder="Enter name" name="name" value="<?=set_value('name')?>">
